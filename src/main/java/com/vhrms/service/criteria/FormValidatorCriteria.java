...
/**
 * Criteria class for the {@link com.vhrms.domain.FormValidator} entity. This class is used
 * in {@link com.vhrms.web.rest.FormValidatorResource} to receive all the possible filtering options from
...
public class FormValidatorCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, value, formName, fieldName, status, companyId, lastModified, lastModifiedBy, distinct);
    }
